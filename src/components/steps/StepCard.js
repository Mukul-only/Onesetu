const StepCard = (props) => {
  return (
    <div className="flex relative rounded-lg bg-white px-8 xl:px-12  py-16 flex-col items-center max-w-max shadow-card">
      <div className="absolute flex items-center justify-center rounded-full w-20 h-20 xl:w-24 xl:h-24 text-xl xl:text-3xl border-2 border-fadeBlue -top-10 left-1/2 -translate-x-1/2 xl:translate-x-0 xl:-top-8 xl:-left-8 bg-white font-semibold text-darkBlue">
        {props.step}
      </div>
